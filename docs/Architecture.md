...
What exact response did the source return?

book_observations

What did the extractor/process interpret from that evidence?

books

What does the system currently trust?

book_history

How did trusted state actually change?
